...
wget -c http://download.kde.org/stable/$pkgname/$pkgname-$pkgver.tar.xz -O $pkgname-$pkgver.tar.xz
wget -c https://aur.archlinux.org/cgit/aur.git/plain/qt5_use_modules.patch?h=systemd-kcm -O  qt5_use_modules.patch
